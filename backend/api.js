...
mongoose.connect("mongodb://localhost/bookproj", {
    useCreateIndex: true,
    useNewUrlParser: true
  },(err)=>
  {
   console.log("connect witn db of the book project..")
  });
  let adminLogin=require('./db/adminlogin');
  let catModel=require('./db/category');
let proModel=require('./db/product');
let feedModel=require('./db/myfeeedback');
let cartModel=require('./db/mycart');
let userModel=require('./db/myuser');
let orderModel=require('./db/myorder');
